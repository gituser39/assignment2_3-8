...
<div class="container-fluid">
    ...
    <div class="row align-items-center justify-content-center">
        ...
        <div class="col-12 col-md-10 col-lg-10 col-12 align-items-center justify-content-center">
            ...
            <div class="alert alert-success" v-if="showMsg === 'update'" :value="true"> Movie information has been updated.
            </div>
            <div class="alert alert-success" v-if="showMsg === 'deleted'" :value="true"> Selected Movie has been deleted.
                </div>
            </div>
        </div>
